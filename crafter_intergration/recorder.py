...
class StatsRecorder:
    ...
    def __init__(self, env, directory, average_interval=100):
        self._env = env
        ...
        self._n_episodes = 0
        self._n_steps = 0
        self._lengths = collections.deque(maxlen=average_interval)
        self._rewards = collections.deque(maxlen=average_interval)
        self._cumulative_achievements = collections.Counter()
    ...
    def step(self, action):
        ...
        if done:
            ...
            for key, value in info['achievements'].items():
                ...
                self._cumulative_achievements[key] += int(value > 0)
            self._save()
    ...
    def crafter_statistics(self):
        ...
        crafter_statistics['step'] = self._n_steps

        return crafter_statistics
