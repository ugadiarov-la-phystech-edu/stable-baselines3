    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                norm_advantages = (advantages - advantages.mean(dim=0)) / (advantages.std(dim=0) + 1e-8)
                left_boundary = 2e6
                right_boundary = 3e6
                if self.num_timesteps < left_boundary:
                    ...
                    coef_advantage = 1
                policy_loss = -th.mean(th.sum(probs * (coef_advantage * advantages + (1 - coef_advantage) * norm_advantages), dim=1))
